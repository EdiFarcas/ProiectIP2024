...
///tabla_dimensiune merge momentan pe dimensiune de tabla intre 3-6 inclusiv;
...
void setings_changes(){
    ...
    setcolor(WHITE);
    settextstyle(DEFAULT_FONT, HORIZ_DIR, 10);
    int titlu_x = (getmaxx()) / 2 - textwidth("Setings")/2;
    int titlu_y = (getmaxy() - textheight("Setings")) / 8;
    outtextxy(titlu_x, titlu_y, "Setings");
